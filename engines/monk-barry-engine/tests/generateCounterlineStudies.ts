/**
 * Generate counterline studies — barry-guitar, barry-piano, monk-guitar, monk-piano.
 */
...
function main() {
  ...
  console.log('Monk/Barry Engine — Generate Counterline Studies');
  ...
  for (const t of TARGETS) {
    ...
    const filename = result.filename ?? `${t.engine}-${t.instrument}-counterline.musicxml`;
